...
<a href="categoria_add.php">   <button type="button" class="btn btn-success">Agregar nueva</button> </buttom> </a>
    ...
    <?php
        ...
        foreach($datosJson as $cat){ ?>
            <tr>
                ...
                <td><a href="categoria_add.php?edit=<?php echo $cat['id']?>"> <button type="button" class="btn btn-light">Modificar</button></a> - 
                    <a href="categoria_mod.php?del=<?php echo $cat['id']?>"> <button type="button" class="btn btn-danger">Borrar</button></td>
